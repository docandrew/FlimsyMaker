...
Public Sub DownloadBigFile(sUrl As String, filePath As String, Optional overWriteFile As Boolean)
  ...
  If hInternet Then
    ...
    Call IterateProgressTPP(totalRead, fileSize)
    ...
    oStream.Close
    Call frmProgressTPP.CloseProgressBarTPP
  End If
